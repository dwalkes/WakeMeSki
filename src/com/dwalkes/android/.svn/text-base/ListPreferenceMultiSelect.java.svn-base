...
public class ListPreferenceMultiSelect extends ListPreference {
    ...
    /**
     * Gets an array representing the list of selected entries as String objects.
     * @return A string object representing the list of selected entries, or null if the list could not be obtained
     */
    ...
    /**
     * @return A string array representing the persisted values in this multi-select list, or
     * null if they could not be obtained.
     */
