...
import android.skireport.Location;


/**
 * A class containing resort information destined for persistent storage
 * Uses android.skireport.location as the base location detail.
 * 
 * @author dan
 *
 */
public class Resort implements Serializable {
	...
	/**
	 * @param wakeupEnabled true to configure wakeup check for this resort
	 */
	 ...
	 * @param resortList A set of resorts to search in
	 * @return null if not found, or a resort with location matching this location
	 */
	public static Resort getResortWithLocation( Location location, Set<Resort> resortList ) {
